...
\title{AgentOS: An Agentic Framework with Built-in Safety and Extensible Skills via ROMA Decomposition and MOSAIC Verification}
...
%%% PDF metadata
\hypersetup{
  pdftitle={AgentOS: An Agentic Framework with Built-in Safety and Extensible Skills via ROMA Decomposition and MOSAIC Verification},
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\linewidth]{agentos-architecture.pdf}
\caption{AgentOS Pipeline Architecture. User input flows through: (1) Context Engineering for intent alignment, (2) ROMA + INTENT Planner for recursive decomposition, (3) HTAA + ToolTree Executor for tool selection, (4) MOSAIC Safety Check for threat detection, (5) InfiAgent + ChromaDB Memory for state management, and (6) REDEREF Reflection for self-improvement. Dangerous commands are refused at the safety layer.}
